"""FastAPI route registration for Alex."""
...
def register_api_routes(app: FastAPI) -> None:
    ...
    from interfaces.api.v1.import_routes import router as import_router
    ...
    _include_registered_routes(
        app,
        (
            RouterRegistration(import_router, API_V1_PREFIX, ("import",)),
