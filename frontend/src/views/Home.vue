    ...
    <div class="home-content" :class="{ 'sidebar-collapsed': sidebarCollapsed }">
      ...
      <div class="container">
        ...
        <footer class="home-footer">
          <span class="footer-brand">Alex</span>
          <span class="footer-sep">·</span>
          <span class="footer-sub">Alex</span>
          <span class="footer-text">ALEX 抖音号：li663028</span>
          <span class="footer-text">AI 驱动的智能小说创作平台</span>
        </footer>
      </div>
    </div>
...
const ImportModal = defineAsyncComponent(
  () => import('@/components/import/ImportModal.vue'),
)
...
const importNovelOptions = computed(() =>
  books.value.map(b => ({ id: b.slug, title: b.title }))
)
