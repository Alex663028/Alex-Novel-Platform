...
const PRESET_TO_SCALE: Record<ApDuskyVeil62, number> = {
  small: 0.875,
  medium: 1,
  large: 1.125,
  xlarge: 1.25,
...
function ApCrimsonDrift5(n: number): number {
  return Math.round(n * 10) / 10
}

/** 将设计稿基准 px 按全局字体档位缩放，供 Naive themeOverrides 使用 */
export function ApAmberVeil84(basePx: number, ApIvoryHarbor52: ApDuskyVeil62): string {
