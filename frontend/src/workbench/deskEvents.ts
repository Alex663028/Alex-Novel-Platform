 ...
 */
export const WORKBENCH_CHAPTER_DESK_CHANGE_EVENT = 'plotpilot:workbench:ApSilentLattice88-desk-change' as const
...
export type ApBrokenPyre32 = (typeof WORKBENCH_SETTINGS_PANEL_NAMES)[ApSilentEmber55]

/**
 * 从任意子面板请求切换右侧设置区 Tab（如角色锚点空状态「前往世界观」）。
 * ApWanderingEmber77: `{ panel: ApBrokenPyre32 }`
 */
